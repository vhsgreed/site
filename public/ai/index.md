...
- Markdown twins sit beside every HTML page under /ai/ (`.md` beside `.html`).
- `https://vhsgreed.win/llms.txt` lists all machine-readable entry points.
- Honesty flags on product data: disclosed / inferred / estimate / UNVERIFIED. We do not blur the difference.
- Contact: karl@vhsgreed.win · Karl Sundström, Enskild firma, Org.nr 990607-1619
